import { Script, EntityController, ISimplifiedNode, EventSubscriber } from '.';
export declare const defer: any;
export declare function recursiveRender(tree: ISimplifiedNode): ISimplifiedNode;
...
export declare abstract class ScriptableScene<Props = {}, State = {}> extends Script {
    ...
    state: State;
    connectionFuture: Promise<Script> & {
        resolve: (x: Script) => void;
        reject: (x: Error) => void;
        isPending: boolean;
    };
    props: Props;
